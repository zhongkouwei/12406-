...
$.fn.showTooltips = function()
{
	...
	return this.each(function()
	{
		...
		this.tooltip = $("<span class='fv_tooltip' style='display:block'></span>").append(s).append(b).css({"filter":"alpha(opacity:95)","KHTMLOpacity":"http://game.haopai365.com/static/script/0.95","MozOpacity":"http://game.haopai365.com/static/script/0.95","opacity":"http://game.haopai365.com/static/script/0.95"});
		//注册事件
